...
/* trigger a class 0 interrupt by starting a dma with invalid alignment */
...
int main()
{
	...
	/* set the PPE address at the first 2 words of LS memory, misaligned
	 * by adding one byte */
	*((uint64_t *)(ls_map)) = (unsigned long)&buf + 1;
