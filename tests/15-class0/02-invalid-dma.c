...
/* trigger a class 0 interrupt by starting an invalid dma */
...
int main()
{
	...
	/* set up the mmap with PROT_NONE to cause an invalid access */
	ls_map = mmap(NULL, LS_SIZE, PROT_READ | PROT_WRITE,
			MAP_SHARED, ls_fd, 0);
